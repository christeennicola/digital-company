...
@section('admin_main_content')
    ...
    <body>
        ...
        <h1 style="text-align:center;padding-top: 60px;padding-bottom:60px;">A Portofolio Table</h1>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center" style="white-space: nowrap; width: 150px;">
                                <div class="d-flex justify-content-center align-items-center gap-2">
                                    <a href="{{ route('porto.edit', $info->id) }}"
                                    ...
                                    <form id="delete-form-{{ $info->id }}"
                                        action="{{ route('porto.destroy', $info->id) }}" method="POST"
