...
@section('admin_main_content')
    ...
    <body>
        ...
        <h1 style="text-align:center;padding-top: 60px;padding-bottom:60px;">A Service Table</h1>
                            ...
                            <td class="align-middle text-center" style="white-space: nowrap; width: 150px;">
                                <div class="d-flex justify-content-center align-items-center gap-2">
                                    ...
                                    <form id="delete-form-{{ $info->id }}"
                                        action="{{ route('service.destroy', $info->id) }}" method="POST"
